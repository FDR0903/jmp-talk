...
These slides: [https://www.faycaldrissi.com/jmp-talk/3](https://www.faycaldrissi.com/jmp-talk/3)
...
- Billions of dollars are traded daily on automated market makers (AMMs)

- Fundamental computational constraint: AMMs are the only viable market structure for decentralised trading

- DEX efficiency actively influences discussions on blockchain design

- Yet, very little is known about the microstructure of DEXs within the infrastructure they are embedded in

- Existing research studies AMMs in isolation (Lehar and Parlour (2021); Capponi and Jia (2021); Barbon and Ranaldo (2021); Cartea, Drissi, and Monga (2022); John, Kogan, and Saleh (2023))
...
- We model strategic interactions between takers and suppliers of liquidity as a three-stage game
    - **stage 0**: multiple traders decide whether to acquire information
    - **stage 1**: liquidity suppliers sets the AMM’s reserves
    <br>
...
- We model strategic interactions between takers and suppliers of liquidity as a three-stage game
    - **stage 0**: multiple traders decide whether to acquire information
    - **stage 1**: liquidity suppliers sets the AMM’s reserves
    - **stage 2**: informed traders compete with priority fees throughout an epoch
...
- Contrary to the widespread push for shorter slots in blockchain design, block time, in the presence of priority fees, enhances DEX efficiency
    - price efficiency: equilibrium number of informed traders grows with block time
    - market liquidity: increased competition for queue priority stabilises informed trading volume, mitigates adverse selection costs, and improves liquidity
- the benefits of longer block time and priority fees come at the cost of slower information dissemination
    - in equilibrium, informed traders reveal their private signals right before the market clears, i.e., block creation
- when the number of informed traders is limited (high technological barriers or limited blockchain adoption). Block time:
    - increases revenue from uninformed demand 
    - increases speculative profits no longer constrained by increased competition in PGAs (prices have more time to diffuse)
- When the number of informed traders in the DEX is limited, we show that there exists a threshold for block time where liquidity suppliers are deterred from entering the market, so markets shut down
...
<br /><br /><br /><br /><br /><br />
<p style="text-align: center;"><h1>
Stage two: priority fees and trading volumes <a name="defi"></a></h1>
</p>
...
<br /><br /><br /><br /><br /><br />
<p style="text-align: center;"><h1>
Stage zero: information acquisition <a name="defi"></a></h1>
</p>
...
<br /><br /><br /><br /><br /><br />
<p style="text-align: center;"><h1>
Equilibrium properties <a name="defi"></a></h1>
</p>
